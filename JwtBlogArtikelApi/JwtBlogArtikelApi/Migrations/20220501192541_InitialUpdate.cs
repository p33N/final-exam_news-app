...
namespace JwtBlogArtikelApi.Migrations
{
    public partial class InitialUpdate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtilceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleTags", x => new { x.TagId, x.ArtilceId });
                    table.ForeignKey(
                        name: "FK_ArticleTags_Articles_ArtilceId",
                        column: x => x.ArtilceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookmarks", x => new { x.UserId, x.ArtilceId });
                    table.ForeignKey(
                        name: "FK_Bookmarks_Articles_ArtilceId",
                        column: x => x.ArtilceId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleTags_ArtilceId",
                table: "ArticleTags",
                column: "ArtilceId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookmarks_ArtilceId",
                table: "Bookmarks",
                column: "ArtilceId");
            ...
            migrationBuilder.Sql(@" CREATE TRIGGER userliked_trig
                                    AFTER INSERT ON `userlikes` FOR EACH ROW
                                    begin
            ...
            migrationBuilder.Sql(@" CREATE TRIGGER userdisliked_trig
                                    BEFORE Delete ON `userlikes` FOR EACH ROW
                                    begin
                                           DECLARE id_exists Boolean;
                                           -- Check BookingRequest table
                                           SELECT 1
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"drop trigger userliked_trig");
            migrationBuilder.Sql(@"drop trigger userdisliked_trig");
        }
    }
}
